...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    title: `404 Not found | ${shortTitle} - a simple note sharing app`,
    description:
      "Uh oh! The page you are looking for does not exist. Unfortunately, we cannot find the page you are looking for.",
    openGraph: {
      images: [
        {
          ...
          width: 800,
          height: 600,
          alt: `${shortTitle} - a simple note sharing app`,
        },
      ],
    },
  };
